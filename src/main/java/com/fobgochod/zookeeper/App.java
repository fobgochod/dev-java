package com.fobgochod.zookeeper;
...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String connectString = "172.16.2.96:2181,172.16.2.97:2181,172.16.2.214:2181";
        ...
        final ZooKeeper zk = new ZooKeeper(connectString, 3000, new Watcher() {
            //Watch 的回调方法！
            @Override
